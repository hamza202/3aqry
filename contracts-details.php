...
<head>
    <meta charset="utf-8"/>
    <title>عقاري | تفاصيل العقد</title>
        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper my-profile">
            ...
            <div class="m-subheader ">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="m-subheader__title ">تفاصيل القد</h3>
                    </div>
                </div>
            </div>
                            ...
                            <div class="m-portlet__body">
                                <div class="m-card-profile">
                                    <div class="m-card-profile__details">
                                        <span class="m-card-profile__name font-size-2">رقم بطاقة المالك</span class="m-card-profile__name">
                                    </div>
                                    <div class="m-card-profile__details">
                                ...
                                <div class="m-card-profile">
                                    <div class="m-card-profile__details">
                                        <span class="m-card-profile__name font-size-2">رقم بطاقة المستأجر</span class="m-card-profile__name">
                                    </div>
                                    <div class="m-card-profile__details">
                                        <h5 class="font-size-3">123456789</h5>
                                    </div>
